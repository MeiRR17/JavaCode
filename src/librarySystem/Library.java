...
public class Library {
    ...
    static void addUsersToAFile(Object users) {
        ...
        PrintWriter pw;
        try {
            fw = new FileWriter("src/librarySystem/people.txt", true);
...
//            String selectUserType = in.nextLine();
//            if (selectUserType.equals("user")) {
//            while (true) {
//
//                    System.out.println("sign in/register");
//                    String signInOrRegister = in.nextLine();
...
//                    }
//                }else{
//                    System.out.println("Could not understan that...");
//                    selectUserType = in.nextLine();
//                }
//
//            }
//
