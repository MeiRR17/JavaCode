package src.DaitelBookPracticing.ch11.section6;

// Fig. 11.5: UsingExceptions.java// try...catch...finally exception handling mechanism.
public class UsingExceptions
{
    ...
    public static void throwException() throws Exception
    {
        ...
        catch (Exception exception) // catch exception thrown in try
        {
            ...
            // code here would no       t be reached; would cause compilation errors
